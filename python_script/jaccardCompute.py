...
def com_jaccard(file_path, column_name, column_type, rg_index1, rg_index2):
    rg1_dict = dict()
    union_num = 0
    join_num = 0
...
if __name__=="__main__":
    ...
    _jaccard = com_jaccard(file_path, column_name, column_type, rg_index1, rg_index2)
    ...
    rg_index1, rg_index2 = get_2_diff_index(get_file_rg_num(file_path))
    _jaccard = com_jaccard(file_path, column_name, "date", rg_index1, rg_index2)
