...
FROM
  hive.hetu_tpcds_parquet_1000.catalog_sales cs1
, hive.hetu_tpcds_parquet_1000.date_dim
, hive.hetu_tpcds_parquet_1000.customer_address
, hive.hetu_tpcds_parquet_1000.call_center
WHERE ("d_date" BETWEEN CAST('2002-2-01' AS DATE) AND (CAST('2002-2-01' AS DATE) + INTERVAL  '60' DAY))
   ...
   SELECT *
   FROM
     hive.hetu_tpcds_parquet_1000.catalog_sales cs2
   ...
   SELECT *
   FROM
     hive.hetu_tpcds_parquet_1000.catalog_returns cr1
