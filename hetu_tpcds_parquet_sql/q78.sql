...
WITH
  ws AS (
   ...
   LEFT JOIN hive.hetu_tpcds_parquet_1000.web_returns ON ("wr_order_number" = "ws_order_number")
      AND ("ws_item_sk" = "wr_item_sk"))
   INNER JOIN hive.hetu_tpcds_parquet_1000.date_dim ON ("ws_sold_date_sk" = "d_date_sk"))
...
, cs AS (
   ...
   LEFT JOIN hive.hetu_tpcds_parquet_1000.catalog_returns ON ("cr_order_number" = "cs_order_number")
      AND ("cs_item_sk" = "cr_item_sk"))
   INNER JOIN hive.hetu_tpcds_parquet_1000.date_dim ON ("cs_sold_date_sk" = "d_date_sk"))
...
, ss AS (
   ...
   LEFT JOIN hive.hetu_tpcds_parquet_1000.store_returns ON ("sr_ticket_number" = "ss_ticket_number")
      AND ("ss_item_sk" = "sr_item_sk"))
   INNER JOIN hive.hetu_tpcds_parquet_1000.date_dim ON ("ss_sold_date_sk" = "d_date_sk"))
