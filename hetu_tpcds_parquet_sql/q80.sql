...
WITH
  ssr AS (
   ...
   LEFT JOIN hive.hetu_tpcds_parquet_1000.store_returns ON ("ss_item_sk" = "sr_item_sk")
...
, csr AS (
   ...
   LEFT JOIN hive.hetu_tpcds_parquet_1000.catalog_returns ON ("cs_item_sk" = "cr_item_sk")
      AND ("cs_order_number" = "cr_order_number"))
   , hive.hetu_tpcds_parquet_1000.date_dim
   , hive.hetu_tpcds_parquet_1000.catalog_page
   , hive.hetu_tpcds_parquet_1000.item
   , hive.hetu_tpcds_parquet_1000.promotion
...
, wsr AS (
   ...
   LEFT JOIN hive.hetu_tpcds_parquet_1000.web_returns ON ("ws_item_sk" = "wr_item_sk")
      AND ("ws_order_number" = "wr_order_number"))
   , hive.hetu_tpcds_parquet_1000.date_dim
   , hive.hetu_tpcds_parquet_1000.web_site
   , hive.hetu_tpcds_parquet_1000.item
   , hive.hetu_tpcds_parquet_1000.promotion
...
FROM
  (
   SELECT
     'hive.hetu_tpcds_parquet_1000.store channel' "channel"
