  ...
  (
   ...
   FROM
     (
      ...
      FROM
        (hive.hetu_tpcds_parquet_1000.web_sales ws
      LEFT JOIN hive.hetu_tpcds_parquet_1000.web_returns wr ON ("ws"."ws_order_number" = "wr"."wr_order_number")
  ...
  (
   ...
   FROM
     (
      ...
      FROM
        (hive.hetu_tpcds_parquet_1000.catalog_sales cs
      LEFT JOIN hive.hetu_tpcds_parquet_1000.catalog_returns cr ON ("cs"."cs_order_number" = "cr"."cr_order_number")
...
UNION SELECT
  'hive.hetu_tpcds_parquet_1000.store' "channel"
, "store"."item"
, "store"."return_ratio"
, "store"."return_rank"
, "store"."currency_rank"
  ...
  (
   ...
   FROM
     (
      ...
      FROM
        (hive.hetu_tpcds_parquet_1000.store_sales sts
      LEFT JOIN hive.hetu_tpcds_parquet_1000.store_returns sr ON ("sts"."ss_ticket_number" = "sr"."sr_ticket_number")
